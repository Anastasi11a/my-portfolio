    ...
    return (
        <Container fluid className="min-vh-100 d-flex flex-column justify-content-center align-items-center pt-5 bg-home">
            <Row className="align-items-center justify-content-center">
                <Col xs={4} md={3} className="text-center mb-3">
                    <Image
                        src={avatar}
            ...
            <Row>
                <Col className="text-center mb-5">
                    ...
                    <p className="mb-2 fs-2 fw-bold text-accent">{content.bio1}</p>
                    <p className="mb-3 fs-4 fw-bold text-dark-text">{content.bio2}</p>
